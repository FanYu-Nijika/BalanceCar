...
#define MSCL_Pin GPIO_PIN_10
#define MSCL_GPIO_Port GPIOB
#define MSDA_Pin GPIO_PIN_11
...
#define OSCL_Pin GPIO_PIN_8
#define OSCL_GPIO_Port GPIOB
#define OSDA_Pin GPIO_PIN_9
#define OSDA_GPIO_Port GPIOB
